...
function showMealPopup(meal) {
    ...
    newPopup.innerHTML = `
        ...
        <div class="right">
            ...
            <div class="modal-body">
                <iframe src="https://youtube.com/embed/${meal.strYoutube.slice(-11,)}" frameborder="0" width="100%" height='300'></iframe>
            </div>
            ...
            <div>
            <a href="feedback.html" style="align : center">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
    ...
    //     <source src="https://youtu.be/BoD0TIO9nE4" type="video/mp4"/>
    //     </video>
    // </div >
    // function myFunction() {
